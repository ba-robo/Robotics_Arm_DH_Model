...
if __name__ == "__main__":
    L = [
        ...
        rtb.RevoluteDH(a=0.360, alpha=0, d=0.00151, offset=0),   # actual in opposite direction

        rtb.RevoluteDH(a=0.3035, alpha=0, d=0, offset=0),        # actual in opposite direction

        rtb.RevoluteDH(a=0, alpha=-pi / 2, d=0.1135, offset=0),  # actual in opposite direction
